...
load("PCSK9.Rdata"); source("focusedMR.R")
...
V <- which(55505221 <= dat0$pos & dat0$pos <= 55530525)
...
ggsave(filename="PCSK9.png", plot=plot1, device="png",width=15,height=8,dpi=300)